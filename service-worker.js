// service-worker.js - キャッシュ制御 const CACHE_NAME = 'sennin-ongame-cache-v1'; const urlsToCache = [ '/', '/index.html', '/style.css', '/script.js', '/score.js', '/manifest.json', '/icon-192.png', '/icon-512.png' ];
